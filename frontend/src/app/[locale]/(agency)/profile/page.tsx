...
export default function ProfilePage() {
  ...
  const inputClass =
    "h-11 w-full rounded-full border border-border-input bg-surface-card px-5 font-sarabun text-body-md text-text-primary placeholder:text-text-muted focus:border-[#01579b] focus:outline-none focus:ring-2 focus:ring-[#01579b]/20";
              ...
              <div className="relative">
                ...
                {editing && (
                  <button
                    ...
                    className="absolute -bottom-1 -right-1 flex h-7 w-7 items-center justify-center rounded-full bg-[#01579b] text-white shadow-level-1 hover:opacity-90"
                  >
